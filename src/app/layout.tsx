...
export const metadata: Metadata = {
  title: "Intimacy Plus - Premium Wellness & Personal Care Products",
  description: "Discover premium wellness products for personal care and intimate well-being. Quality, discretion, and customer satisfaction guaranteed.",
  keywords: "wellness products, personal care, intimate wellness, premium quality, discreet service",
  metadataBase: new URL("https://intimacyplus.com"),
  alternates: {
    canonical: "https://intimacyplus.com"
  },
  openGraph: {
    title: "Intimacy Plus - Premium Wellness Products",
    description: "Premium wellness products for personal care and intimate well-being",
    siteName: "Intimacy Plus",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/6267375/pexels-photo-6267375.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Intimacy Plus wellness products"
      }
    ]
  },
  twitter: {
    ...
    title: "Intimacy Plus - Premium Wellness Products",
    description: "Premium wellness products for personal care and intimate well-being",
    images: ["https://images.pexels.com/photos/6267375/pexels-photo-6267375.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
